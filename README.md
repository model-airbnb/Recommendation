...
The recommendations servive publishes messages that has recommendation weights for the search service. The sort order scores are used by the search service to sort search results.
